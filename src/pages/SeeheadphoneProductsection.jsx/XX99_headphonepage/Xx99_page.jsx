      ...
      <div className=" borderfull pt-10 pb-[4rem] pr-[10rem] pl-[4em] flex  gap-20 product-content">
        <div className="features">
          ...
          <p className="text-[0.9375rem] text-[rgba(0,0,0,0.5)] font-normal">
            ...
            demonstrates over
            <br />
            five decades of audio expertise, redefining the critical listening
            experience. This pair of
            <br />
          ...
          <p className="text-[0.9375rem] text-[rgba(0,0,0,0.5)] font-normal mt-[1.5rem]">
            ...
            headband with inner
            <br />
            damping element, the components work together to deliver comfort and
            <br />
            uncompromising sound. Its closed-back design delivers up to 27 dB of
            passive noise
            <br />
      ...
      <div className="parent borderfull pt-10 pb-[4rem] pr-[10rem] pl-[4em] relative h-[100%] grid lg:grid-cols-[auto,auto] grid-cols-[auto] gap-3 mt-5 product-gallery">
        <div className="speaker speaker2 relative h-[100%] overflow-hidden">
          <img
            ...
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/desktop/image-gallery-1.jpg"
          />
          <img
            className="h-[100%] w-[auto] rounded-lg phone-image"
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/mobile/image-gallery-1.jpg"
          />
        </div>
        ...
        <div className="speaker speaker2  relative h-[100%] overflow-hidden row-span-2">
          <img
            className="lg:h-[100%] w-[auto] rounded-lg hidden"
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/desktop/image-gallery-3.jpg"
          />
          <img
            className="h-[100%] w-[auto] rounded-lg phone-image"
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/mobile/image-gallery-2.jpg"
          />
        </div>
        ...
        <div className="speaker speaker2 w-[100%] relative h-[100%] overflow-hidden ">
          <img
            className="lg:h-[100%] w-[auto] rounded-lg hidden"
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/desktop/image-gallery-2.jpg"
          />
          <img
            className="h-[100%] w-[auto] rounded-lg phone-image"
            src="https://audiophile-ecommerce-mbart13.vercel.app/images/product-xx99-mark-one-headphones/mobile/image-gallery-3.jpg"
          />
        </div>
      </div>
      <Ambassador />
