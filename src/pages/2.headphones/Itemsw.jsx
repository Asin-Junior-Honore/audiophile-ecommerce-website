  ...
  const Itemsdetails = [
    {
      id: "XX59",
      imgSrc:
        "https://audiophile-ecommerce-mbart13.vercel.app/images/category-headphones/desktop/image-xx59.jpg",
      isNew: "New product",
      productName: (
        <>
          {" XX59"} <br /> {"HEADPHONES "}
      ...
      productDes: (
        <>
          ...
          <br /> {"specific tastes with the XX59 headphones. The stylish yet"}
          <br />
